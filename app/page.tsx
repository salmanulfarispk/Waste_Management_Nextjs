  ...
  return (
   <div className="container mx-auto px-4 py-16">
       <section className="text-center mb-20">
            ...
            <button className="btn bg-green-600 hover:bg-green-700 text-white text-lg py-2 px-8 rounded-3xl">
               Report Waste
            </button>
       </section>
...
function FeatureCard({icon:Icon, title,description}:{icon:React.ElementType; title:string; description:string}){
  return (
    <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-lg transition-all duration-300 ease-in-out
...
function ImpactCard({title,value, icon:Icon}:{title:string; value: number | string ; icon: React.ElementType}){
  return(
    <div className="p-6 rounded-xl bg-gray-50 border border-green-100 transition-all duration-300 ease-in-out hover:shadow-md">
